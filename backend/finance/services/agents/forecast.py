...
class ForecastAgent:
    ...
    def forecast(transactions: list, days: int = 30) -> dict:
        ...
        Доходи {inc_trend_str}, в середньому {avg_weekly_income:.0f} грн/тиж.
        Прогноз на {days} днів — витрати {forecast_expense:.0f} UAH, надходження {forecast_income:.0f} UAH, баланс {forecast_income - forecast_expense:.0f} UAH.
